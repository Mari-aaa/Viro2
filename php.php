  ...
  <body>
    ...
    <div class="container mt-2">
      <div class="row">
        <div class="col-12">
          <div class="jumbotron">
            <h1 class="text-center">VIRO Interface&nbsp;</h1>
            <div class="row justify-content-center">
              <div class="col-auto">
                <p><a class="btn btn-success btn-lg" href="#" role="button">ON&nbsp;</a> </p>
              </div>
              <div class="col-auto">
                <p><a class="btn btn-primary btn-lg" href="#" role="button">OFF&nbsp;</a> </p>
              </div>
            </div>
            <p class="text-center">&nbsp;Hi, I'm Viro!&nbsp; &nbsp; &nbsp;</p>
            <img src="images/robot.jpg" alt="" width="152" height="152" class="img-fluid"> 
          </div>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="row">
        ...
        <div class="text-center col-md-6 col-12">
          <h3>Musik&nbsp;</h3>
          <p>&nbsp;</p>
          <a class="btn btn-info btn-lg" href="#" role="button">ON&nbsp;</a>
		<a class="btn btn-danger btn-lg" href="#" role="button">OFF&nbsp;</a>
